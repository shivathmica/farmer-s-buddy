           ...
           select:
            ...
            if ($result) {
                ...
                if ($row) {
                     ...
                     //echo "success";
                     //echo $cat_id[0];
                     $sql = "INSERT INTO stocks (user_id,category_id,name,quantity,price,doh,dop,expiry_date,description,image) VALUES ( '$userid','$cat_id[0]','$name','$qty','$price','$doh',now(),'$doe','$desp','$file');";
                     $result = mysqli_query($conn,$sql);
                     if($result) {
                         //echo "success";
